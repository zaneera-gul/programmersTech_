...
public class viewAllRecords extends javax.swing.JFrame {
    ...
    public void setDetails(){
        try{
            ...
            while(rs.next()){
                ...
                String bAuthor = rs.getString("studentId");
                String sname = rs.getString("studentname");
                String idate = rs.getString("issuedate");
                String duedate = rs.getString("duedate");
                String status = rs.getString("status");
                Object[] obj = {bid,bName,bAuthor,sname,idate,duedate,status};
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(33, 51, 71));
        ...
        record.setSurrendersFocusOnKeystroke(true);
